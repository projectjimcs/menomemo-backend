...
export class initialize1640208486452 implements MigrationInterface {
    name = 'initialize1640208486452'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`users\` (\`id\` int NOT NULL AUTO_INCREMENT, \`firstname\` varchar(255) NOT NULL, \`lastname\` varchar(255) NOT NULL, \`email\` varchar(255) NOT NULL, \`password\` varchar(255) NOT NULL, \`uuid\` varchar(36) NOT NULL, \`phone\` int NULL, \`company_id\` int NULL, \`status\` varchar(255) NOT NULL DEFAULT 'active', \`usertype_id\` int NOT NULL, \`is_doctor\` tinyint NOT NULL DEFAULT 0, \`refresh_token\` varchar(255) NULL, \`refresh_token_exp\` timestamp NULL, \`created_by\` int NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` timestamp(6) NULL, UNIQUE INDEX \`IDX_97672ac88f789774dd47f7c8be\` (\`email\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`patients\` (\`id\` int NOT NULL AUTO_INCREMENT, \`firstname\` varchar(255) NOT NULL, \`lastname\` varchar(255) NOT NULL, \`uuid\` varchar(36) NOT NULL, \`email\` varchar(255) NULL, \`phone\` varchar(20) NOT NULL, \`company_id\` int NOT NULL, \`status\` varchar(255) NOT NULL DEFAULT 'active', \`created_by\` int NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` timestamp(6) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`bookings\` (\`id\` int NOT NULL AUTO_INCREMENT, \`company_id\` int NOT NULL, \`date\` date NOT NULL, \`start_time\` time NULL, \`end_time\` time NULL, \`title\` varchar(255) NOT NULL, \`notes\` varchar(255) NULL, \`patient_id\` int NOT NULL, \`booked_by\` int NOT NULL, \`booked_with\` int NOT NULL, \`is_completed\` tinyint NOT NULL DEFAULT 0, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` timestamp(6) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
